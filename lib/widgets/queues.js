(function() {
    ...
    exports.init = function() {
        ...
        panels.on('queue.select', function(id) {
            ...
            'get',
            {
                ...
                onOk: function(response) {
                    ...
                    if(queues.length){
                        ...
                        panels.emit('queue.reset');
                        panels.emit('queue.fill', queues, storage.widgets.queues.selected);
                    ...
                    api.asyncRequest(
                        ...
                        'get',
                        {
                            onOk: function(response) {
                                ...
                                panels.emit('queue.size', response.json.id, size);
                            },
                            onUnauthorized: function() {
                                console.info('widget.unauthorized: ' + name);
