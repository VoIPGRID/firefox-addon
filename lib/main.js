...
exports.main = function(options) {
    ...
    //             data.url('assets/js/tabsize.js')
    //         ],
    //         onMessage: function(message){
    //             window_height = message - 15;

    //             mainpanel.port.emit('resize', {
    //                 width: mainpanel.widht,
    ...
    mainpanel.port.on('resize', function(size) {
        // var height = window_height < size.height
        ...
        mainpanel.resize(mainpanel.width, height);
    });
...
function startQueueTimer(){
    ...
    dump('Queue refrash timeout: ' + timeout + '\n');
...
function displayloginform() {
    ...
    mainpanel.port.emit('updatecontacts', {type: 'clear'});
    ...
    request({
        ...
        onComplete: function(response) {
            if (response.status == 200) {
                ...
                mainpanel.port.emit('updatecontacts', 
